...
const tabs = [
  ...
  { id: 1002, label: "Notaría 9", className: "purple" },
  { id: 1003, label: "MUBI::", className: "blue" },
  { id: 1004, label: "Hiking Map", className: "yellow" },
  { id: 1005, label: "To-do list", className: "red" },
];
  ...
  return (
    <>
      <div className="card">
        ...
        <h1 className="font-sub-titles">Ros's Classified File.</h1>
        <div className="tabs">
          {tabs.map((tab, index) => (
            <button
              key={tab.id}
