export const allMainArticles = [
  ...
  },
  {
    ...
    content:
      "One of the most important things i had been overlooking, while developing this portafolio, was the the optimization of media loading, such as videos and images. Interms of user experience, is important to ensure that the website remains responsive to any changes that may occur. For this reason I decided to manage the loading state in some components(images, and video). In the same way as error handling, especially when resources are limited or the user has a slow Wi-Fi connection (issues like these might happpen)",
    paragrapsArticle: [
      {
        subtitleParagraph: undefined,
        paragraph:
          "I tackled this challenge by using the useState( ) hook, asynchronous functions (async/await), and promises (new Promise). It's like my program is saying ' I promise you to either make a request and display your videos, or shows an error message if i'm unable to retrieve the information (due to lack of the resource ...etc)'",
        lista: [],
        codeSnippet: {},
        code: "",
      },
      ...
      },
      {
        subtitleParagraph: undefined,
        paragraph:
          "It's important to keep in mind that the JavaScript environment was designed as a synchronous programming languaje, which implies a single thread of execution. As a result of this approach: tasks are executed one by one in sequential order. A very similar similar situacion happens when your are waiting in the checkout line at a grocery store to pay. you can only pay once it's your turn.",
        lista: [],
        codeSnippet: {},
        code: "",
      },
      ...
      },
      {
        ...
        codeSnippet: {
          alignDiv: "sectionCodeSnippetSingleColumn",
          codeBreakdown: [],
          codeTitleImg: "🌐 Renderizado Condicional 3.1. Video",
          codePreview:
